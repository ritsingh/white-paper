...
function CarrierSection() {
  return (
    <>
    <div className="bg-cover bg-center bg-no-repeat h-screen w-screen justify-end relative bg-[url(../public/carrier-bg.png)] h-2/3 flex md:items-center about-us-header-container">
